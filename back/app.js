...
const fieldsOptions = {
  "Steps walked": { min: 100, max: 200, operator: "sum", unit: "" },
  "Calories burned": { min: 100, max: 200, operator: "sum", unit: "cal" },
  "Heart-rate average": { min: 100, max: 200, operator: "avg", unit: "bpm" },
  "Remaining battery": { min: 100, max: 200, operator: "avg", unit: "%" },
  "Consumption history": { min: 100, max: 200, operator: "sum", unit: "Watt" },
  "Estimated costs": { min: 100, max: 200, operator: "sum", unit: "" },
  "Distance traveled": { min: 100, max: 200, operator: "sum", unit: "m" },
  "Floors climbed": { min: 100, max: 200, operator: "sum", unit: "" },
  "Air Quality Index": { min: 100, max: 200, operator: "avg", unit: "" },
  "Fine particle levels": { min: 100, max: 200, operator: "avg", unit: "" },
  "Oxygen Concentration": { min: 100, max: 200, operator: "avg", unit: "%" },
  "Average temperature": { min: 100, max: 200, operator: "avg", unit: "°C" },
  "Average humidity": { min: 100, max: 200, operator: "avg", unit: "" },
  "Sunshine exposure": { min: 100, max: 200, operator: "sum", unit: "min" },
  "Lightning intensity": { min: 100, max: 200, operator: "avg", unit: "lux" },
  "Time on": { min: 100, max: 200, operator: "sum", unit: "min" },
  "Body Weight": { min: 100, max: 200, operator: "avg", unit: "kg" },
  "Body Mass Index": { min: 100, max: 200, operator: "avg", unit: "" },
  "Muscle rate": { min: 100, max: 200, operator: "avg", unit: "%" },
  "Body Water rate": { min: 100, max: 200, operator: "avg", unit: "%" },
  "Bodyfat rate": { min: 100, max: 200, operator: "avg", unit: "%" },
  "Body Age": { min: 100, max: 200, operator: "avg", unit: "years" },
};
